...
/**
 * Централізовані константи назв view (Thymeleaf-шаблонів) та redirect-адрес.
 * Мета — прибрати "магічні рядки" з контролерів: назва шаблону/маршруту
 * визначається один раз тут, а контролери лише посилаються на константу.
 * Це дає підказки IDE, захист від друкарських помилок і один рядок для
 * зміни, якщо шлях до шаблону чи маршрут колись зміняться.
 */
